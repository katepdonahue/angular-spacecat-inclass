...
spacecatApp.controller('CatListCtrl', function($scope) {  // this is the way we connect the application to the controller
  $scope.cats = [                                         // $scope is a place where we store resources, where all of the data is
    { "id": 1,
      "name": "bigbelly",                                 // this  defines the resource as 'cats'
